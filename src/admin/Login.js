...
class Login extends Component {
    ...
    autenticaUsuario(){
        ...
        auth.signInAndRetrieveDataWithEmailAndPassword(this.email.value, this.senha.value)
        .then(user => {
            ...
            <div className="container">
                <h1>Login</h1>
                    ...
                    <div className="form-group">
                        ...
                        {
                            this.state.erro && <small id="emailHelp" className="form-text text-muted">Email e/ou senha invalido</small>
                        }
